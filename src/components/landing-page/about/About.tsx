    ...
    <div className="py-20 max-w-[1024px] mx-auto border-b ">
      ...
      <main className="relative pt-20">
        <div className="absolute top-[20%]">
          <h2 className="text-[#D9432C] text-4xl font-medium mb-4">
              NICUB at a Glance
          </h2>
          <p className="text-md max-w-[400px] text-gray-600">
            NICUB drives open source innovation, enabling impactful
            collaborations and fostering a thriving global community of
            contributors.
          </p>
        </div>
        <div className="flex items-end flex-col gap-6 h-[45rem] bgblack scroll-bar">
